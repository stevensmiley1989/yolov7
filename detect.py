...
def detect(save_img=False):
    ...
    if  use_socket:
        ...
        try:
            ...
            use_socket=False
    use_socket_receive_imgs=opt.use_socket_receive_imgs
    if use_socket_receive_imgs:
        import socket
        import threading
    ...
    while DO_THE_LOOP:
        if LOOP:
            ...
            #yolov7_model.send('READY'.encode())
            source=yolov7_model.recv(1024)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--use_socket_receive_imgs",action='store_true',help='if you want to receive images from a set path given by labelimg and send predictions to labelimg')
